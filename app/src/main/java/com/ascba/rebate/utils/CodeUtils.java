...
public class CodeUtils {
    public static final int REQUEST_USER_HEAD = 2017;
    public static final int REQUEST_NICK_NAME = 2018;
    public static final int REQUEST_CAMERA_ICON = 2019;
    public static final int REQUEST_ALBUM_ICON = 2020;
    public static final int REQUEST_REGISTER_PHONE = 2021;
    public static final int REQUEST_REGISTER_CODE = 2022;
    public static final int REQUEST_REGISTER_DATA = 2023;
    public static final int REQUEST_COMPANY = 2026;
    ...
    public static final int REQUEST_PAY = 2034;
    public static final int REQUEST_ADD_CARD = 2035;
    public static final int REQUEST_CASH_GET = 2036;
    public static final int REQUEST_ADDRESS = 2037;
    public static final int REQUEST_OPEN = 2038;
    public static final int REQUEST_SCORE_EXCHANGE = 2039;
