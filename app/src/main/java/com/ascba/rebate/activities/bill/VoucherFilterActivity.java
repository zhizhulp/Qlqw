...
public class VoucherFilterActivity extends BaseDefaultNetActivity implements View.OnClickListener {
    ...
    protected int bindLayout() {
        return R.layout.activity_filter_voucher;
    }
        ...
        if (pvTime == null) {
            pvTime = new TimePickerView.Builder(this, new TimePickerView.OnTimeSelectListener() {
                ...
                public void onTimeSelect(Date date, View v) {//选中事件回调
                    ...
                    paged = 1;
                    data.clear();
                    VoucherFilterActivity.this.date = dateFormat;
