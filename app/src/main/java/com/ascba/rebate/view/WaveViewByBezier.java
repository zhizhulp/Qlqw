...
public class WaveViewByBezier extends View {
	...
	private void initParams(Context context, AttributeSet attrs) {
		...
		if (typedArray != null) {
            color_bg = typedArray.getColor(R.styleable.WaveViewByBezier_color_bg, Color.WHITE);
            typedArray.recycle();
		}
	...
	private void init() {
		mWaveAmplitude = dp2px(4);//5
		mWaveLength = dp2px(500);//300
		initPaint();
	}
	...
	private void initPaint() {
		...
		//mWavePaint.setColor(getResources().getColor(R.color.transparentWhite));
        mWavePaint.setColor(color_bg);
