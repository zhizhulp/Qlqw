...
public class EasyStatusView extends RelativeLayout {
    ...
    public static final int DEFAULT_EMPTY_LAYOUT = R.layout.esv_layout_empty_default;
    public static final int DEFAULT_ERROR_LAYOUT = R.layout.esv_layout_error_default;
    public static final int DEFAULT_LOADING_LAYOUT = R.layout.esv_layout_loading_default;
    public static final int DEFAULT_NONETWORK_LAYOUT = R.layout.esv_layout_nonetwork_default;
    ...
    public EasyStatusView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mEmptyLayoutId = a.getResourceId(R.styleable.EasyStatusView_esv_empty, DEFAULT_EMPTY_LAYOUT);
        mErrorLayoutId = a.getResourceId(R.styleable.EasyStatusView_esv_error, DEFAULT_ERROR_LAYOUT);
        mLoadingLayoutId = a.getResourceId(R.styleable.EasyStatusView_esv_loading, DEFAULT_LOADING_LAYOUT);
        mNoNetworkLayoutId = a.getResourceId(R.styleable.EasyStatusView_esv_noNet, DEFAULT_NONETWORK_LAYOUT);
        a.recycle();
    }
