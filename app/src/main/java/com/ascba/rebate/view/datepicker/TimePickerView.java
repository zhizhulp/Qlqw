package com.ascba.rebate.view.datepicker;
...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    private void initView(Context context) {
        ...
        if (customListener == null) {
            ...
            //设置文字
            btnSubmit.setText(TextUtils.isEmpty(Str_Submit) ? "确定" : Str_Submit);
            btnCancel.setText(TextUtils.isEmpty(Str_Cancel) ? "取消" : Str_Cancel);
