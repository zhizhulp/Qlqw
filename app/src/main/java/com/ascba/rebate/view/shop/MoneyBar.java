...
public class MoneyBar extends LinearLayout implements View.OnClickListener {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        LayoutInflater.from(context).inflate(R.layout.shop_bar_layout, this, true);
        ...
        int bgColor = ta.getColor(R.styleable.MoneyBar_barBg, getResources().getColor(R.color.white));
        title = ta.getString(R.styleable.MoneyBar_textTitle);
        String tailStr = ta.getString(R.styleable.MoneyBar_textTail);
        int titleTextColor = ta.getColor(R.styleable.MoneyBar_titleColor, getResources().getColor(R.color.grey_black_tv));
        ...
        int backImgId = ta.getResourceId(R.styleable.MoneyBar_backImg, R.mipmap.back_small);
        int backTextColor = ta.getColor(R.styleable.MoneyBar_backTextColor, context.getResources().getColor(R.color.grey_black_tv));
