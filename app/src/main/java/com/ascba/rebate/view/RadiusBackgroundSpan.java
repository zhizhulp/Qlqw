...
public class RadiusBackgroundSpan extends ReplacementSpan {
    ...
    public RadiusBackgroundSpan(Context context, int bgColorResId, String text) {
    ...
    private void initDefaultValue(Context context, int bgColorResId, String text) {
        ...
        this.mTextSize = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 11, mContext.getResources().getDisplayMetrics());
    ...
    public void draw(@NonNull Canvas canvas, CharSequence text, int start, int end, float x, int top, int y, int bottom, Paint paint) {
        ...
        mTextPaint.setTextSize(mTextSize);
        mTextPaint.setAntiAlias(true);
        mTextPaint.setTextAlign(Paint.Align.CENTER);  //这个只针对x有效
