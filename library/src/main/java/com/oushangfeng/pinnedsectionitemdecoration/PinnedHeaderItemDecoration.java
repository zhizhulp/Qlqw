...
public class PinnedHeaderItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public interface OnHeaderChangeListener {
        void onChange(int position,View headView);
    }

    public void setmOnHeaderChangeListener(OnHeaderChangeListener mOnHeaderChangeListener) {
        this.mOnHeaderChangeListener = mOnHeaderChangeListener;
    }
// 当我们调用mRecyclerView.addItemDecoration()方法添加decoration的时候，RecyclerView在绘制的时候，去会绘制decorator，即调用该类的onDraw和onDrawOver方法，
    ...
    private void createPinnedHeader(final RecyclerView parent) {
        ...
        if (pinnedHeaderPosition >= 0 && mPinnedHeaderPosition != pinnedHeaderPosition) {
            ...
            Log.d(TAG, "createPinnedHeader: "+pinnedHeaderPosition);
            if (mOnHeaderChangeListener != null) {
                mOnHeaderChangeListener.onChange(mPinnedHeaderPosition,mPinnedHeaderView);
            }
